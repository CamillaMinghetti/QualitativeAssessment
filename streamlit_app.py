...
st.write(
    ...
    "where <span style="color:blue">blue represents the deepest areas</span>, transitioning through green and yellow for intermediate depths, "
    "and finally <span style="color:red">red indicating the shallowest areas</span>.**"
)
