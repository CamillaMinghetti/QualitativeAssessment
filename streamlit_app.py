...
# Gestione della sessione per le pagine
...
if st.session_state.page == 1:
    ...
    # Pulsante "Continue" che passa alla pagina successiva
    if st.button("Continue"):
        st.session_state.page = 2  # Cambia alla pagina 2
        st.rerun()  # Ricarica la pagina per mostrare la seconda pagina

# Pagina 2: Descrizione del questionario
    ...
    # Aggiungi un'immagine esplicativa del modello di profondità
    #st.image("./frame_00379.png", caption="Example Depth Maps from AI Models", use_container_width=True)

    # Pulsante "Start Questionnaire" per iniziare il vero e proprio questionario
    if st.button("Start Questionnaire"):
        st.session_state.page = 3  # Cambia alla pagina 3 (inizio del questionario)
        st.rerun()  # Ricarica la pagina per mostrare il questionario

elif st.session_state.page == 2:
    # Page 2 Content (Main Questionnaire)
    st.write("### Main Questionnaire")
    st.write(
        "Now, please proceed with the questionnaire below to evaluate the depth maps."
    )
